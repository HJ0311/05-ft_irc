...
{//TODO * -> 클라이언트로 바꿔야함 , printf 사용할 것으로 올바른 플래그 넣어주기
	...
	std::string RPL_451 = ":ircserv 451 :You have to authenticate!\r\n";
	std::string RPL_461 = ":ircserv 461 PASS :Not enough parameters.\r\n";
	std::string RPL_462 = ":ircserv 462 :You may not register.\r\n";
	std::string RPL_464 = ":ircserv 464 :Incorrect password.\r\n";
	std::string RPL_433 = ":ircserv 433 jungslee :Nickname is already in use.\r\n";
	std::string RPL_431 = ":ircserv 431 :No nickname given.\r\n";
	std::string RPL_432 = ":ircserv 432 jungslee :Erroneus nickname\r\n";
